...
<html lang="en">
    <head>
        ...
        <title>Student Records - SB Admin</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                This section of the webpage displays the data table showcasing the relevant information of the student. It offers a structured and organized presentation of the student's details, facilitating easy access and reference for efficient student data management and analysis.
